            ...
            <div className="flex-1 overflow-y-auto relative scrollbar-thin scrollbar-thumb-zinc-800">
                ...
                <div className="p-6 space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className={cn(
                        ...
                        query.impact_score > 80 ? "bg-red-500/5 border-red-500/20" :
                            query.impact_score > 50 ? "bg-amber-500/5 border-amber-500/20" :
                    ...
                    <AnimatePresence>
                        {sectionsOpen.costAnalysis && (
                            ...
                            >
                                <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-md p-4 space-y-2">
                    ...
                    <div className="border border-border rounded-md overflow-hidden bg-gradient-to-r from-primary/5 to-transparent">
                        <button
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <CodeContainer code={suggestion.sql_fix} className="bg-card border border-primary/30" />
                                </div>
                            </div>
                        </div>
                    )}
